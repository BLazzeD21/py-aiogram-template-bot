...
from keyboards.inline_keyboards import sex_inline_kb, back_inline_kb
...
@router.message(StateFilter(FSMRegistration.fill_age), lambda x: x.text.isdigit() and 1 <= int(x.text) <= 100)
